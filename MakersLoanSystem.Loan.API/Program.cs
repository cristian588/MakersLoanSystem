...
using MakersLoanSystem.Loan.API.Infrastructure.Repositories;
...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssemblyContaining<CreateLoanCommand>());
